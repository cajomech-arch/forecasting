...
estimating the parameters, and generating the forecasts, the SARIMA(1,1,1)(0,1,1)[12] model which was selected based on the initial ACF and PACF diagnostics, appears to provide a strong fit. 
The forecast plot shows that, with 95% confidence, the predicted values remain consistent with the historical pattern and variability. 
